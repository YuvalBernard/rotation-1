...
<\body>
  ...
  <\equation*>
    <around*|{|<tabular|<tformat|<table|<row|<cell|<wide|x|\<dot\>><rsub|1>>>|<row|<cell|<wide|x|\<dot\>><rsub|2>>>|<row|<cell|<wide|x|\<dot\>><rsub|3>>>|<row|<cell|<wide|x|\<dot\>><rsub|4>>>>>>|}>=<bmatrix|<tformat|<table|<row|<cell|-R<rsub|2>>|<cell|\<Delta\>\<omega\>>|<cell|0>|<cell|0>>|<row|<cell|-\<Delta\>\<omega\>>|<cell|-R<rsub|1>>|<cell|\<omega\><rsub|1>>|<cell|0>>|<row|<cell|0>|<cell|-\<omega\><rsub|1>>|<cell|-R<rsub|1>>|<cell|R<rsub|1>*M<rsub|z><rsup|0>>>|<row|<cell|0>|<cell|0>|<cell|0>|<cell|0>>>>>\<cdot\><around*|{|<tabular|<tformat|<table|<row|<cell|x<rsub|1>>>|<row|<cell|x<rsub|2>>>|<row|<cell|x<rsub|3>>>|<row|<cell|x<rsub|4>>>>>>|}>+0
  </equation*>
  ...
  <\equation*>
    <around*|{|<tabular|<tformat|<table|<row|<cell|y>>>>>|}>=<around*|[|<tabular|<tformat|<table|<row|<cell|0>|<cell|0>|<cell|1>|<cell|0>>>>>|]>\<cdot\><around*|{|<tabular|<tformat|<table|<row|<cell|x<rsub|1>>>|<row|<cell|x<rsub|2>>>|<row|<cell|x<rsub|3>>>|<row|<cell|x<rsub|4>>>>>>|}>+<around*|[|<tabular|<tformat|<table|<row|<cell|0>>>>>|]>\<cdot\><around*|{|<tabular|<tformat|<table|<row|<cell|F>>>>>|}>
  </equation*>
