...
w1 = 150;
dw = 2500;
t0 = 0; tmax = 5; q = 10000; t = t0:(tmax-t0)/(q-1):tmax;
T1 = [0.1,0.5,1,2,10];
...
for i = 1:length(T1)
    ...
    [Mz_ss,t_ss] = blochSS_alt(T1(i),T2,w1,dw);
...
for i = 1:length(T2)
    ...
    [Mz_ss,t_ss] = blochSS_alt(T1,T2(i),w1,dw);
...
for i = 1:length(w1)
    ...
    [Mz_ss,t_ss] = blochSS_alt(T1,T2,w1(i),dw);
...
for i = 1:length(dw)
    ...
    [Mz_ss,t_ss] = blochSS_alt(T1,T2,w1,dw(i));
