...
parameters {
  ...
  real<lower=2> kappa; // "concentration" of beta dist.
                      // dist is unimodal if kappa > 2.
}
...
transformed parameters {
  ...
  alpha = Z_tilde * (kappa - 2) + 1;
  beta = (1 - Z_tilde) * (kappa - 2) + 1;
}
...
model {
   ...
   f ~ cauchy(0.02,0.005);
   k ~ cauchy(285,10);
   kappa ~ normal(2,50); // I have no clue what this should be...
