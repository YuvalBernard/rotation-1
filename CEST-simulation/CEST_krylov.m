function [Z,A,domain,varargout] = CEST_krylov(T1a,T2a,T1b,T2b,kb,M0a,M0b,dwa,db,w1,varargin)
% Simulation of Bloch-McConnell equations
% by solving differential equations in the
% rotating frame.

%~~~~~~~~~ Solve using Krylov subspace projection techniques. ~~~~~~~~~~~
